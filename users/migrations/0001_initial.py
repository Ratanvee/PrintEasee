# Generated by Django 4.2.19 on 2025-02-25 06:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_url', models.SlugField(blank=True, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('in_process', 'In Process'), ('completed', 'Completed')], default='pending', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_type', models.CharField(choices=[('black_white', 'Black & White'), ('color', 'Color'), ('both', 'Both')], default='black_white', max_length=11)),
